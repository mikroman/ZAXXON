/*
EXROM	active (lo) (0), GAME	active (lo) (0)
CRT header info:
...
$0010- xxxx - <code>
Two 8KB banks   ($A000-$BFFF)
One 4KB bank    ($8000-$8FFF)
One 4KB bank    ($9000-$9FFF) mirrored from $8000
A bank switch occurs when either 4KB bank is addressed.
EXROM ($18 = $00) and GAME ($19 = $00) lines are always pulled to GND to select the 16 KB ROM configuration.
The binfile includes three of four banks in CHIP blocks:
    ($9000 bank is not included as it is a miror of $8000.)
