...
>.crt contents follow with gaps for code. Only headers.
...
The cartridge uses two 8KB banks at address space $A000-$BFFF and a 4KB ROM at $8000-$8FFF, mirrored at address space $9000.
When either 4KB space is addressed a bank switch occurs.
EXROM ($18 = $00) and GAME ($19 = $00) lines are always pulled to GND to select the 16 KB ROM configuration.

The binfile will include three CHIP blocks: (note $9000 is not included.)
